    ...
    return (
      <div className="p-6 space-y-6" style={{ backgroundColor: bgColor }}>
        ...
        {settings.helpLevel === 'Full' && (
          ...
          >
            <p style={{ fontSize: settings.fontSize, fontWeight: '550', color: settings.colorMode === 'High Contrast' ? '#000' : '#1e40af', textAlign: 'center' }}>
              {settings.language === 'Plain Language' ? '📍 Pagina principale' : '💡 Tocca le card per i dettagli'}
            </p>
          </motion.div>
        )}
        ...
        {settings.helpLevel === 'Voice' && (
          ...
          >
            <p style={{ fontSize: settings.fontSize, fontWeight: '550', color: '#0f766e', textAlign: 'center' }}>
              🎤 {settings.language === 'Plain Language' ? 'Parla per usare l\'app' : 'Usa il comando vocale'}
            </p>
          </motion.div>
        )}
        ...
        {settings.helpLevel === 'Voice' && (
          ...
          >
            <p style={{ fontSize: settings.fontSize, fontWeight: '550', color: '#0f766e' }}>
              🎤 {settings.language === 'Plain Language' ? 'Di\' "Apri visite"' : 'Usa comandi vocali'}
            </p>
          </motion.div>
        )}
    ...
    <div className="p-4 space-y-3" style={{ backgroundColor: bgColor }}>
      {settings.helpLevel === 'Full' && (
        ...
        >
          <p style={{ 
            ...
            💡 {settings.language === 'Plain Language' ? 'Tocca le card' : 'Suggerimento: Tocca una card per vedere i dettagli'}
          </p>
        </motion.div>
      )}
      ...
      {settings.helpLevel === 'Voice' && (
        <motion.div
          ...
          className="bg-teal-50 border-l-4 border-teal-500 p-3 rounded"
        >
          <p style={{ fontSize: settings.fontSize === '14px' ? '12px' : '14px', color: '#0f766e', fontWeight: '550' }}>
            🎤 {settings.language === 'Plain Language' ? 'Parla con l\'app' : 'Usa il comando vocale per navigare'}
          </p>
        </motion.div>
      )}
